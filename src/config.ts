...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: false,
		src: "https://s1.imagehub.cc/images/2025/08/06/75eb8551ea578cfa71cc37fd40ef7eaf.webp", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
